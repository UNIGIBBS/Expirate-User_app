...
class cardListOthers extends StatefulWidget {
  cardListOthers({Key? key, required this.id}) : super(key: key);

  var id;
  @override
  State<cardListOthers> createState() => _cardListOthersState();
}

class _cardListOthersState extends State<cardListOthers> {
  ...
  getData()async{
    data = FirebaseFirestore.instance.collection("Markets").doc(widget.id).collection("products").snapshots();
  }
